...
const ModalSolicitudEstadisticas: React.FC<ModalSolicitudEstadisticasProps> = ({
  ...
  return (
    <ModalBase isOpen={isOpen} onClose={onClose} title={`Solicitar Estadísticas para ${jugadorNombre || 'Jugador'}`}>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <textarea
            ...
            placeholder="Describe por qué solicitas estas estadísticas..."
            required
          />
        </div>
